...
/* Node identifiers */
#define STREAMNB_IDENTIFIED_NODES 15
...
#define STREAMGAIN_ID 6
#define STREAMSPECTROGRAMLEFT_ID 7
#define STREAMSPECTROGRAMRIGHT_ID 8
#define STREAMTOCOMPLEXLEFT_ID 9
#define STREAMTOCOMPLEXRIGHT_ID 10
#define STREAMTO_F32_ID 11
#define STREAMWINLEFT_ID 12
#define STREAMWINRIGHT_ID 13
#define STREAMDISPLAY_ID 14
