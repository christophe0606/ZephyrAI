...
This demo has been tested with an old version of the Alif repository.

Use sdk-alif Commit  1e1d38883a59e121592c1f23f3d4185453587cbe of
https://github.com/alifsemi/sdk-alif 

There were problems with the display on more recent version.

Unfortunately, there are issues with this old commit and they need to be solved first. See below.

In the future, I'll try to upgrade the demo to work with latest versions on Alif github repo.
