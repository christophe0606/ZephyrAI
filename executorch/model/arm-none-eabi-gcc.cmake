...
elseif(EXISTS "${ARM_TOOLCHAIN_PATH2}/arm-none-eabi-gcc" AND EXISTS "${ARM_TOOLCHAIN_PATH2}/arm-none-eabi-g++")
    message(STATUS "Found ARM toolchain in ExecuTorch path: ${ARM_TOOLCHAIN_PATH2}")
    set(CMAKE_C_COMPILER "${ARM_TOOLCHAIN_PATH2}/arm-none-eabi-gcc")
    set(CMAKE_CXX_COMPILER "${ARM_TOOLCHAIN_PATH2}/arm-none-eabi-g++")
    set(CMAKE_ASM_COMPILER "${ARM_TOOLCHAIN_PATH2}/arm-none-eabi-gcc")
    set(CMAKE_LINKER "${ARM_TOOLCHAIN_PATH2}/arm-none-eabi-ld")
else()
...
add_compile_options(
  ...
  -fno-pic -fno-pie
  -imacros ${ZEPHYR_STDINT_COMPAT_H}
)
